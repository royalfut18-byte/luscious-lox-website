...
export const homeSeo = {
  title: 'Hair Extensions & Hair Salon Neutral Bay | Lusciouslox',
  description:
    'Lusciouslox is a luxury hair salon in Neutral Bay specialising in nano extensions, tape extensions, balayage, colour, keratin treatments and styling.',
  canonical: `${siteUrl}/`,
};
...
export const seoPages: Record<string, SeoPage> = {
  '/hair-salon-neutral-bay': {
    ...
    title: 'Hair Salon Neutral Bay | Lusciouslox',
    description:
      'Looking for a hair salon in Neutral Bay? Lusciouslox offers premium hair extensions, balayage, colour, keratin treatments, blow drys and styling.',
    h1: 'Hair Salon Neutral Bay',
    heroIntro:
      'Lusciouslox is a luxury hair salon in Neutral Bay, specialising in premium nano extensions, tape extensions, balayage, colour, keratin treatments, blow drys and styling.',
    openingCopy:
    ...
    sectionParagraphs: [
      ...
      'Clients visit Lusciouslox for precision colour work, glossy balayage, smoothing keratin treatments, event-ready styling, and extension applications designed to look soft, natural, and easy to maintain.',
    ...
    detailsTitle: 'What to expect at Lusciouslox',
    detailsParagraphs: [
    ...
    imageAlt: 'Lusciouslox salon exterior in Neutral Bay',
    relatedLinks: [
  ...
  '/hair-extensions-neutral-bay': {
    ...
    title: 'Hair Extensions Neutral Bay | Lusciouslox',
    description:
      'Discover premium hair extensions in Neutral Bay at Lusciouslox. We specialise in seamless nano extensions, tape extensions, colour matching and personalised consultations.',
    h1: 'Hair Extensions Neutral Bay',
    heroIntro:
      'Lusciouslox provides luxury hair extensions in Neutral Bay, Sydney, with personalised consultations, premium Remy human hair, and seamless blends designed for natural movement and comfort.',
    openingCopy:
    ...
    sectionParagraphs: [
      ...
      'Clients across Neutral Bay choose Lusciouslox for premium extension work because we tailor each install around your density, haircut, desired finish, and how often you can return for maintenance.',
    ...
    imageSrc: heroImage,
    imageAlt: 'Long seamless hair extensions styled at Lusciouslox',
    relatedLinks: [
  ...
  '/balayage-neutral-bay': {
    ...
    title: 'Balayage Neutral Bay | Lusciouslox',
    description:
      'Book balayage in Neutral Bay with Lusciouslox. We create soft, dimensional colour with personalised toning, glossing and styling for a polished salon finish.',
    h1: 'Balayage Neutral Bay',
    heroIntro:
      'Lusciouslox offers balayage in Neutral Bay for clients who want dimensional colour, soft grow-out, and a polished finish tailored to their complexion, haircut, and maintenance preferences.',
    openingCopy:
    ...
    sectionParagraphs: [
      ...
      'At Lusciouslox, each balayage appointment in Neutral Bay includes a consultation around tone, placement, brightness, and aftercare so your result complements both your features and your lifestyle.',
    ...
    imageAlt: 'Balayage result created by Lusciouslox in Neutral Bay',
    relatedLinks: [
  ...
  '/tape-extensions-neutral-bay': {
    ...
    title: 'Tape Extensions Neutral Bay | Lusciouslox',
    description:
      'Looking for tape extensions in Neutral Bay? Lusciouslox offers premium tape-in hair extensions with seamless colour matching, natural movement and expert fitting.',
    h1: 'Tape Extensions Neutral Bay',
    heroIntro:
      'Lusciouslox specialises in tape extensions in Neutral Bay, creating lightweight, flat-lay installs that add length and fullness while keeping the finish smooth, soft, and natural.',
    openingCopy:
  ...
  '/nano-hair-extensions-neutral-bay': {
    ...
    title: 'Nano Hair Extensions Neutral Bay | Lusciouslox',
    description:
      'Lusciouslox offers nano hair extensions in Neutral Bay for discreet, natural-looking length and volume with personalised placement and premium Remy human hair.',
    h1: 'Nano Hair Extensions Neutral Bay',
    heroIntro:
      'Lusciouslox is known for nano hair extensions in Neutral Bay, delivering discreet attachment points, premium Remy hair, and custom placement for soft, undetectable results.',
    openingCopy:
    ...
    imageAlt: 'Nano hair extensions result by Lusciouslox',
    relatedLinks: [
  ...
  '/keratin-treatment-neutral-bay': {
    ...
    title: 'Keratin Treatment Neutral Bay | Lusciouslox',
    description:
      'Book a keratin treatment in Neutral Bay with Lusciouslox for smoother, shinier, more manageable hair and personalised aftercare advice.',
    h1: 'Keratin Treatment Neutral Bay',
    heroIntro:
      'Lusciouslox offers keratin treatment services in Neutral Bay for clients who want smoother, shinier, more manageable hair with less frizz and easier styling between salon visits.',
    openingCopy:
    ...
    imageAlt: 'Smooth glossy hair after keratin treatment at Lusciouslox',
    relatedLinks: [
  ...
  '/hair-extensions-mosman': {
    ...
    title: 'Hair Extensions Mosman | Lusciouslox',
    description:
      'Looking for hair extensions near Mosman? Lusciouslox in Neutral Bay offers premium nano, tape and weft extensions with expert colour matching, minutes from Mosman.',
    h1: 'Hair Extensions Mosman',
    heroIntro:
      'Lusciouslox is the go-to hair extension specialist for Mosman clients, located just minutes away in Neutral Bay with premium Remy human hair, seamless blends, and personalised consultations.',
    openingCopy:
    ...
    imageSrc: '/lusciouslox/neutral-bay-2.webp',
    imageAlt: 'Long seamless hair extensions for a Mosman client by Lusciouslox',
    relatedLinks: [
  ...
  '/tape-hair-extensions-neutral-bay': {
    ...
    title: 'Tape Hair Extensions Neutral Bay | Lusciouslox',
    description:
      'Premium tape hair extensions in Neutral Bay. Lusciouslox fits lightweight, colour-matched tape-in hair with seamless blending, gentle wear and easy maintenance.',
    h1: 'Tape Hair Extensions Neutral Bay',
    heroIntro:
      'Lusciouslox fits premium tape hair extensions in Neutral Bay using top-grade Remy human hair, precise colour matching, and placement planned around your haircut for an invisible finish.',
    openingCopy:
    ...
    imageAlt: 'Tape hair extensions styled with soft waves at Lusciouslox Neutral Bay',
    relatedLinks: [
  ...
  '/weft-hair-extensions-sydney': {
    ...
    title: 'Weft Hair Extensions Sydney | Lusciouslox',
    description:
      'Lusciouslox fits premium weft hair extensions in Sydney - seamless wefts applied for maximum volume and length with a flat, comfortable, damage-conscious finish.',
    h1: 'Weft Hair Extensions Sydney',
    heroIntro:
      'Lusciouslox offers premium weft hair extensions for Sydney clients who want serious volume and length in one appointment, with a flat, secure finish designed for comfortable everyday wear.',
    openingCopy:
    ...
    imageAlt: 'Voluminous weft hair extensions result by Lusciouslox Sydney',
    relatedLinks: [
  ...
  '/keratin-bond-hair-extensions-sydney': {
    ...
    title: 'Keratin Bond Hair Extensions Sydney | Lusciouslox',
    description:
      'Keratin bond hair extensions in Sydney by Lusciouslox. Discreet individual bonds, premium Remy hair and expert placement for natural movement and 360-degree wear.',
    h1: 'Keratin Bond Hair Extensions Sydney',
    heroIntro:
      'Lusciouslox applies keratin bond hair extensions for Sydney clients who want individual, strand-by-strand placement with natural movement and the freedom to wear hair up or down.',
    openingCopy:
    ...
    imageSrc: '/lusciouslox/neutral-bay-3.webp',
    imageAlt: 'Keratin bond hair extensions with glossy finish by Lusciouslox Sydney',
    relatedLinks: [
  ...
  '/hair-extensions-cammeray': {
    ...
    title: 'Hair Extensions Cammeray | Lusciouslox',
    description:
      'Hair extensions near Cammeray - Lusciouslox in Neutral Bay fits premium nano, tape and weft extensions with expert colour matching, minutes from Cammeray.',
    h1: 'Hair Extensions Cammeray',
    heroIntro:
      'Cammeray locals choose Lusciouslox for premium hair extensions just minutes away in Neutral Bay - seamless nano, tape, and weft installs with personalised colour matching.',
    openingCopy:
    ...
    imageSrc: '/lusciouslox/neutral-bay-5.webp',
    imageAlt: 'Vibrant hair extension transformation for a Cammeray client by Lusciouslox',
    relatedLinks: [
      { href: '/hair-extensions-neutral-bay', label: 'Explore our hair extensions overview' },
      { href: '/hair-salon-neutral-bay', label: 'Visit our Neutral Bay salon page' },
    ],
  ...
  '/weft-hair-extensions-neutral-bay': {
    ...
    title: 'Weft Hair Extensions Neutral Bay | Lusciouslox',
    description:
      'Weft hair extensions in Neutral Bay by Lusciouslox. Seamless rows of premium Remy hair for maximum volume, a flat comfortable fit and easy maintenance.',
    h1: 'Weft Hair Extensions Neutral Bay',
    heroIntro:
      'Lusciouslox installs weft hair extensions in Neutral Bay for clients who want maximum volume and length with a flat, comfortable row that disappears under your natural hair.',
    openingCopy:
    ...
    sectionTitle: 'The weft experience at Lusciouslox',
    sectionParagraphs: [
    ...
    imageSrc: '/lusciouslox/neutral-bay-1.webp',
    imageAlt: 'Full voluminous weft hair extensions styled at Lusciouslox Neutral Bay',
    relatedLinks: [
  ...
  '/nano-hair-extensions-sydney': {
    ...
    title: 'Nano Hair Extensions Sydney | Lusciouslox',
    description:
      'Nano hair extensions in Sydney by specialists Lusciouslox. Ultra-discreet nano bonds, premium Remy hair and precision placement for undetectable length and volume.',
    h1: 'Nano Hair Extensions Sydney',
    heroIntro:
      'Lusciouslox is one of Sydney’s dedicated nano hair extension specialists - ultra-small bonds, premium Remy hair, and precision placement for a result nobody can detect.',
    openingCopy:
    ...
    imageSrc: '/lusciouslox/extensions-showcase.webp',
    imageAlt: 'Undetectable nano hair extensions by Lusciouslox Sydney',
    relatedLinks: [
  ...
  '/balayage-north-sydney': {
    ...
    title: 'Balayage North Sydney | Lusciouslox',
    description:
      'Balayage near North Sydney - Lusciouslox in Neutral Bay creates dimensional, hand-painted colour with personalised toning and glossing, minutes from North Sydney.',
    h1: 'Balayage North Sydney',
    heroIntro:
      'Lusciouslox creates hand-painted balayage for North Sydney clients just minutes away in Neutral Bay - dimensional colour, soft grow-out, and a glossy, polished finish.',
    openingCopy:
    ...
    imageSrc: '/lusciouslox/neutral-bay-1.webp',
    imageAlt: 'Hand-painted balayage result for a North Sydney client by Lusciouslox',
    relatedLinks: [
