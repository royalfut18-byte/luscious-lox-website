...
export const shopProducts: ShopProduct[] = [
  ...
  },
  {
    ...
    images: [
      { src: '/lusciouslox/micro-topper-16in-1.webp', alt: '16 inch MICRO Hair Topper in blonde ombre Remy human hair' },
      { src: '/lusciouslox/micro-topper-16in-3.webp', alt: '16 inch MICRO Hair Topper Swiss lace base with secure clips' },
      { src: '/lusciouslox/micro-topper-16in-5.webp', alt: '16 inch MICRO Hair Topper showing the natural-looking part' },
      { src: '/lusciouslox/micro-topper-16in-6.webp', alt: '16 inch MICRO Hair Topper with soft waves through the ends' },
