          ...
          <motion.div className="relative" style={{ y: imgY }}>
            ...
            >
              <div className="aspect-[4/5] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden border border-champagne/20 shadow-[0_30px_80px_rgba(176,141,87,0.08)] relative">
                <img src="/lusciouslox/extensions-showcase.webp" alt="Undetectable hair extensions showcase" className="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
